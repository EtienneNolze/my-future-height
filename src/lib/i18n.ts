...
const de: Dict = {
  badge: "Personalisierte Größenschätzung für Kinder & Jugendliche",
  h1_part1: "Wie ",
  h1_tall: "groß",
  h1_part2: " wirst du ",
  h1_grow: "werden",
  h1_q: "?",
  intro:
    "Beantworte so viele Fragen wie möglich — was du nicht weißt, wähle einfach „Ich weiß nicht“. Je mehr du ausfüllst, desto genauer die Schätzung.",
  card_title: "Dein Wachstumsprofil",
  card_desc: "Wechsle zwischen Zentimetern und Zoll. Überspringe, was du nicht weißt.",
  unit_label: "Maßeinheit",
  unit_cm: "cm",
  unit_in: "Zoll",
  sec1_title: "1. Am wichtigsten",
  sec1_sub: "Diese Angaben beeinflussen die Schätzung am stärksten.",
  sec2_title: "2. Körpermaße",
  sec2_sub:
    "Optional — hilfreich, wenn die Elterngröße unbekannt ist. Armspanne ≈ Erwachsenengröße, Fußlänge korreliert gut mit Größe.",
  ...
  current_height: "Deine aktuelle Größe",
  mom_height: "Größe der Mutter",
  dad_height: "Größe des Vaters",
  ...
  shoe_size_hint: "Die Fußlänge wird aus deiner Schuhgröße geschätzt",
  ...
  estimate_btn: "Größe schätzen",
  reset_btn: "Neu starten",
  err_age: "Bitte gib ein Alter zwischen 2 und 25 Jahren ein.",
  err_height: "Bitte gib deine aktuelle Größe ein.",
  result_title: "Deine geschätzte Erwachsenengröße",
  ...
  method_text_strong: "mittlere Elterngröße (Tanner-Methode)",
  method_text_post:
  ...
  important_strong:
    "Alter, Geschlecht, Größe der Eltern, aktuelle Größe und jüngstes Jahreswachstum",
  important_post: ".",
  language: "Sprache",
};
...
const it: Dict = {
  badge: "Stima personalizzata dell'altezza per bambini e adolescenti",
  h1_part1: "Quanto ",
  h1_tall: "alto",
  h1_part2: " diventerai ",
  h1_grow: "da grande",
  ...
  card_title: "Il tuo profilo di crescita",
  card_desc: "Passa tra centimetri e pollici. Salta ciò che non sai.",
  unit_label: "Unità di misura",
  unit_cm: "cm",
  unit_in: "pollici",
  sec1_title: "1. I più importanti",
  sec1_sub: "Hanno il maggiore impatto sulla stima.",
  sec2_title: "2. Misure corporee",
  sec2_sub:
    "Facoltative — utili se l'altezza dei genitori è sconosciuta. L'apertura delle braccia ≈ altezza da adulto e la lunghezza del piede la segue bene.",
  sec3_title: "3. Crescita e sviluppo",
  sec3_sub: "Rilevante solo se stai ancora crescendo.",
  sec4_title: "4. Stile di vita e salute",
  sec4_sub: "Modificano leggermente l'altezza finale.",
  age: "La tua età",
  age_ph: "es. 13",
  yrs: "anni",
  gender: "Sesso alla nascita",
  male: "Maschio",
  female: "Femmina",
  ethnicity: "Origine etnica / regionale",
  eth_european: "Europea",
  eth_east_asian: "Asiatica orientale",
  eth_south_asian: "Asiatica meridionale",
  eth_se_asian: "Sud-est asiatico",
  eth_african: "Africana",
  eth_middle_eastern: "Medio Oriente",
  eth_latin: "Latino-americana",
  eth_mixed: "Mista / Altro",
  dont_know: "Non lo so",
  current_height: "La tua altezza attuale",
  mom_height: "Altezza della madre",
  dad_height: "Altezza del padre",
  leave_blank: "Lascia vuoto se non lo sai",
  weight: "Peso",
  sitting_height: "Altezza da seduto",
  leg_length: "Lunghezza gamba",
  inseam: "Cavallo",
  arm_span: "Apertura delle braccia",
  arm_span_hint: "Da punta a punta delle dita",
  shoulder: "Larghezza spalle",
  hand_length: "Lunghezza della mano",
  shoe_size: "Numero di scarpe",
  shoe_size_hint: "La lunghezza del piede è stimata dal numero di scarpe",
  head_circ: "Circonferenza cranica",
  optional: "facoltativo",
  spurt_age: "Età dello scatto di crescita (se nota)",
  still_growing: "Stai ancora crescendo?",
  yes: "Sì",
  no_stopped: "No, ho smesso",
  no: "No",
  growth_last_year: "Quanto sei cresciuto l'anno scorso?",
  growth_spurt: "Stato dello scatto di crescita",
  spurt_not_yet: "Non ancora iniziato",
  spurt_now: "In corso",
  spurt_done: "Già finito",
  nutrition: "Alimentazione",
  nut_needs_work: "Da migliorare",
  nut_okay: "Discreta",
  nut_balanced: "Equilibrata",
  nut_very_healthy: "Molto sana",
  sleep: "Sonno per notte",
  sleep_lt7: "Meno di 7 ore",
  sleep_7_8: "7–8 ore",
  sleep_8_9: "8–9 ore",
  sleep_9p: "9+ ore",
  exercise: "Attività / sport",
  ex_none: "Non attivo",
  ex_light: "Leggera (1–2 gg/sett.)",
  ex_moderate: "Moderata (3–5 gg/sett.)",
  ex_very: "Molto attiva (6+ gg/sett.)",
  chronic: "Malattia cronica?",
  preterm: "Nato pretermine?",
  smoking: "La madre ha fumato in gravidanza?",
  hormones: "Terapia ormonale?",
  estimate_btn: "Stima la mia altezza",
  reset_btn: "Ricomincia",
  err_age: "Inserisci un'età tra 2 e 25 anni.",
  err_height: "Inserisci la tua altezza attuale.",
  result_title: "La tua altezza da adulto stimata",
  result_desc: "In base a tutto ciò che ci hai detto.",
  likely_range: "intervallo probabile:",
  remember_label: "Nota:",
  remember_text: " questa è una stima personalizzata, non una previsione medica.",
  method_text_pre: "Combina la ",
  method_text_strong: "altezza media dei genitori (metodo di Tanner)",
  method_text_post:
    ", il tuo tasso di crescita attuale e regole antropometriche di base come l'apertura delle braccia e la lunghezza del piede.",
  important_pre: "I dati più importanti sono ",
  important_strong:
    "età, sesso, altezza dei genitori, altezza attuale e crescita annuale recente",
  important_post: ".",
  language: "Lingua",
};

export const DICTS: Record<Lang, Dict> = { en, de, es, fr, it };
